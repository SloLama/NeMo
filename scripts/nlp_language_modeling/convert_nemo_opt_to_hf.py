...
def replace_hf_weights(weights_file, input_hf_path, output_hf_path, llama_tokenizer_path, slopt_tokenizer_path):
...
if __name__ == '__main__':
    ...
    if args.hf_in_path and args.hf_out_path:
        replace_hf_weights(args.out_file, args.hf_in_path, args.hf_out_path, args.llama_tokenizer_path,
