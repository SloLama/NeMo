...
def get_args():
    ...
    parser.add_argument("--nemo-path", type=str, default=DEFAULT_NEMO_PATH,
                        help="Path to the folder containing nemo scripts")
    parser.add_argument(
        "--hparams_file",
        type=str,
    ...
    parser.add_argument("--tokenizer-path", type=str, default="",
                        help="Path to the .model file of sentencepiece tokenizer")
    parser.add_argument("--keep-embeddings", action="store_true",
                        help="True if model has word embeddings initialized with some method(WECHSEL, Focus)")
    parser.add_argument("--tie-embeddings", action="store_true",
                        help="If true, word embedding weights are set as the output layer")
